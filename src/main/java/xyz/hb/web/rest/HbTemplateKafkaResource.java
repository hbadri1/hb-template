...
@RestController
@RequestMapping("/api/hb-template-kafka")
public class HbTemplateKafkaResource {

    private final Logger log = LoggerFactory.getLogger(HbTemplateKafkaResource.class);
    ...
    public HbTemplateKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
